...
# stock_price_prediction documentation build
...
from stock_price_prediction import __version__ as release
...
htmlhelp_basename = "stock_price_predictiondoc"
...
latex_documents = [
    (
        master_doc,
        "stock_price_prediction.tex",
        "stock_price_prediction Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "stock_price_prediction",
        "Project stock_price_prediction codebase.",
        "Data-Science",
    )
]
